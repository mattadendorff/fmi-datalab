...
if __name__ == '__main__':
    ...
    cols = [x for x in df.columns.values if x in
    ...
    tpot = TPOTClassifier(generations=100, population_size=100, verbosity=2, n_jobs=2, scoring='balanced_accuracy')
    tpot.fit(X_train, y_train)
    print(tpot.score(X_test, y_test))
    tpot.export('tpot_fmi_pipeline_sparse_100_100_cont.py')
