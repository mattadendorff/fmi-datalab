...
def visualize_tree(tree, feature_names, filename):
    ...
    command = ["dot", "-Tpng", "dt.dot", "-o", "plots-forest/%s.png" % filename]
    try:
...
def main():
    ...
    #     visualize_tree(tree, HEADERS[1:-1], 'tree_%s' % i)

    plot_importances(trained_model.feature_importances_, HEADERS[1:-1])
